...
class PersonInformation extends StatelessWidget {
  ...
  whatsapp() async {
    const url = "whatsapp://send?phone=+2001025940745";
    await launchUrlString(url);
  }

  facebook() async {
    const url = 'https://www.facebook.com/abdoeslam2002';
    await launchUrlString(url);
  }

  instagram() async {
    const url = 'https://instagram.com/abdoeslam2002';
    await launchUrlString(url);
  }
